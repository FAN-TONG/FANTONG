<%@ Page Language="C#" AutoEventWireup="true" CodeFile="waiter-add.aspx.cs" Inherits="waiter_add" %>
...
<article class="page-container">
	<form id="from1" class="form form-horizontal" runat="server">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">服务员姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">服务员工号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="account" name="account">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">服务员性别：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">服务员电话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="tel" name="tel">
			</div>
		</div>
		<div class="row cl">
