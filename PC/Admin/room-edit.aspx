<%@ Page Language="C#" AutoEventWireup="true" CodeFile="room-edit.aspx.cs" Inherits="Admin_room_edit" %>
...
<article class="page-container">
	<form id="from1" class="form form-horizontal" runat="server">
      <%
          ...
          dt = SQLHelper.Select("select * from room where id=" + ID);
      %>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">房间名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  class="input-text" value="<%Response.Write(dt.Rows[0]["name"]); %>"" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
