<%@ Page Language="C#" AutoEventWireup="true" CodeFile="table-add.aspx.cs" Inherits="table_add" %>
      ...
      %>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="tableId" name="tableId">
			</div>
		</div>
		<div class="row cl">
