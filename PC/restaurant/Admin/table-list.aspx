<%@ Page Language="C#" AutoEventWireup="true" CodeFile="table-list.aspx.cs" Inherits="Admin_table_list" %>
...
<div class="page-container">
      ...
      <%
        ...
        dt = SQLHelper.Select("select * from  [table] left outer join room on([table].roomId=room.id)");
      %>

	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" onclick="picture_add('添加餐桌','table-add.aspx')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>
       添加餐桌</a></span> <span class="r">共有数据：<strong><% Response.Write(dt.Rows.Count.ToString()); %></strong> 条</span> </div>
	<div class="mt-20">
			...
			<tbody>
				...
				<tr class="text-c"> 
					...
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'<%Response.Write(dt.Rows[i]["id"].ToString()); %>')" href="javascript:;" title="下架">
                        ...
                        <a style="text-decoration:none" class="ml-5" onClick="picture_edit('桌子编辑','table-edit.aspx?ID=<%Response.Write(dt.Rows[i]["id"].ToString()); %>',0)" href="javascript:;" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i></a> 
