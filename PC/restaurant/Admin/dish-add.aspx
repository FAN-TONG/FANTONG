<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dish-add.aspx.cs" Inherits="dish_add" %>
	...
	<form class="form form-horizontal" runat="server" id="form1">
      ...
      %>
		...
		<%--<div class="row cl">
         ...
         <div class="row cl" id="div_pic" style="display:none">
            <label class="form-label col-xs-4 col-sm-2">菜品图片：</label>
            <div class="formControls col-xs-8 col-sm-9">
               <img id="preview" width="200" height="150">
            </div>
        </div>
          <div class="row cl">
